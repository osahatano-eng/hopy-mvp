...
export default function ChatClient() {
  ...
  useAutoGrowTextarea(inputRef, input, 420);
...
/*
【今回このファイルで修正したこと】
1. 表示用 userState の正規化とマージ責務を ./view/resolveMergedUserStateForView へ移しました。
2. 親ファイルから normalizedResolvedViewUserState と mergedUserStateForView の useMemo 本体を削除しました。
3. 親ファイルには resolveMergedUserStateForView の呼び出しだけを残し、接続責務へ寄せました。
4. activeThread 解決責務、左カラム状態送出、送信処理、Compass本体、MEMORIES、UI文言、状態の唯一の正、他責務には触っていません。
*/
