...
/*
【今回このファイルで修正したこと】
- 低シグナル入口入力に加えて、短文の軽い感想・軽い前向き発話・軽い応援でも state_changed を立てない指示を追加しました。
- state 5 を許可する条件を、明確な決定・行動開始・方針確定・強い意志表明がある場合だけに絞りました。
- buildTransitionSection / buildThreeStepStructureSection / buildGenerationRulesSection / buildUserInputSection に、軽い短文専用の抑制ルールを追加しました。
