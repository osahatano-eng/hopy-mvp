...
/*
【今回このファイルで修正したこと】
- runJsonForcedCompletion(...) と createPlainCompletion(...) で重複指定されていた max_tokens: params.maxTokens を削除しました。
- max_tokens は phaseParams(...) 側の値だけを使う形にそろえ、TypeScript の重複指定 build error を止めました。
