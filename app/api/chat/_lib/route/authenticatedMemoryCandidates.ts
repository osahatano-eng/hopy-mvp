...
/*
【今回このファイルで修正したこと】
- Pro / Plus で builtResultCandidates が空のときでも heuristic memory 解決へ進んでいた分岐を止めました。
- resolvedPlan !== "free" の場合は、builtResultCandidates をそのまま返し、
  heuristic import / heuristic extraction を実行しないようにしました。
